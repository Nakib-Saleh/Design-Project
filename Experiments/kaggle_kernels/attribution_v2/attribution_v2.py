...
ACTIVE_FACTOR_IDS = ["irrelevant_plausible_fact", "wrong_local_entity", "text_overlay_wrong_answer", "salience_recomposition"]  # GATE:FACTORS
ITEM_OFFSET = 0  # GATE:OFFSET
RESULTS_PATH = "/kaggle/working/attribution_v2_results.jsonl"  # GATE:RESULTS
# ---------------------------------------------------------------------
